...
const Test = () => {
    const [data,setData]=useState(
     ...
     console.log("data 1 : ",data.airAirPricePointList.airAirPricePoint)
    //  console.log("data 2 : ",data1.airAirPricePointList.airAirPricePoint)
    ...
    useEffect(() => {
        ...
        // console.log("flight data ", airPricePoints);
        const allFlights = [];
        ...
        airPricePoints.forEach((pricePoint) => {
            ...
            airOptions.forEach((option) => {
                ...
                const flightDetail = {
                    ...
                    airpriceInfo: {
                        FareBreakDowns: {
                            priceStatus: pricePoint['airAirPricingInfo'],
                            // // airAirPricePointList.airAirPricePoint[0].airAirPricingInfo["@attributes"]
                            // // cancelPanality: pricePoint['airAirPricingInfo'].airAirPricingInfo,
                ...
                airFareInfolist: fareInfoRefs.map(segKey => {
                    const segment = airFareinforeList.find(s => s['@attributes'].Key === segKey);
                    if (segment) {
                        return segment;
                    }
                    return null; // Return null if no segment is found
